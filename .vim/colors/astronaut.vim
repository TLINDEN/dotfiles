...
exe "hi Comment        start=[m[37m      stop=[m[32m   ctermfg=".s:magenta."                             guifg=white                           term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi Delimiter      start=[m[37m      stop=[m[32m   ctermfg=".s:yellow."                             guifg=white       guibg=navyblue      term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi Identifier     start=[m[45m      stop=[m[32m   ctermfg=".s:white."                           guifg=magenta     guibg=navyblue      term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi Normal         start=[m[32m      stop=[m[32m   ctermfg=".s:white."                             guifg=green       guibg=navyblue      term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi Search         start=[m[33;44m   stop=[m[32m   ctermfg=".s:black."    ctermbg=".s:yellow."      guifg=yellow      guibg=blue          term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi StatusLine     start=[m[30;46m   stop=[m[32m   ctermfg=".s:blue."     ctermbg=".s:white."      guifg=black       guibg=cyan          term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
exe "hi StatusLineNC   start=[m[30;42m   stop=[m[32m   ctermfg=".s:blue."     ctermbg=".s:white."     guifg=black       guibg=green         term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi VertSplit      start=[m[30;42m   stop=[m[32m   ctermfg=".s:black."     ctermbg=".s:white."     guifg=black       guibg=green         term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
